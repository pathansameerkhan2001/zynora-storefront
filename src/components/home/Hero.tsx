      ...
      <div className="container mx-auto px-6 lg:px-16 relative z-10 pt-16 pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <motion.div 
            ...
            className="lg:col-span-6 flex flex-col gap-8 lg:pe-12"
          >
            <h1 className="font-playfair text-5xl md:text-7xl lg:text-[90px] font-bold leading-[1.1] text-zynora-emerald tracking-tight rtl:tracking-normal">
              {isRTL ? (
                <>
                  صُممت لترتقي<br />
            ...
            <p className="text-lg md:text-xl text-zynora-emerald/70 font-light leading-relaxed max-w-md">
              {t.hero.subtext}
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 mt-4">
              <Link 
                href="/shop" 
                className="group relative px-10 py-4 bg-zynora-emerald text-zynora-cream text-[14px] font-bold tracking-[0.2em] uppercase rounded-full overflow-hidden transition-all duration-500 hover:shadow-[0_20px_40px_rgba(11,46,38,0.2)]"
              >
              ...
              <Link 
                href="/about" 
                className="px-10 py-4 border border-zynora-emerald/20 text-zynora-emerald text-[14px] font-bold tracking-[0.2em] uppercase rounded-full hover:bg-zynora-emerald/5 transition-all duration-500"
              >
                {t.common.ourStory}
              </Link>
            </div>
          ...
          >
            <div className="relative w-full max-w-[600px] aspect-[14/16] rounded-[36px] overflow-hidden border border-zynora-gold/20 shadow-[0_30px_60px_rgba(0,0,0,0.1)] bg-white/5 backdrop-blur-sm">
            ...
            <div className="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-zynora-gold/5 rounded-full blur-[100px] pointer-events-none" />
          </motion.div>
        </div>
      </div>
    </section>
