      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            className="absolute -top-10 start-[-1.5rem] z-20 text-zynora-gold/40"
          >
        ...
        >
          <div>
            <div className="flex items-center gap-2 mb-6">
              <span className="w-12 h-[1px] bg-zynora-gold"></span>
              <span className="text-[11px] font-bold tracking-[0.4em] uppercase text-zynora-gold rtl:tracking-normal">
                {t.whyZynora.badge}
              </span>
            </div>
            <h2 className="font-playfair text-5xl lg:text-7xl font-bold mb-8 text-zynora-emerald leading-[1.1] rtl:tracking-normal">
              {t.whyZynora.headingPart1}
              <span className="text-zynora-gold italic">{t.whyZynora.headingPart2}</span>
            </h2>
            <p className="text-zynora-emerald/70 text-xl font-light leading-relaxed max-w-xl">
              {t.whyZynora.subtext}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            {t.whyZynora.reasons.map((reason, idx) => (
              ...
              >
                <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center border border-zynora-gold/20 shadow-sm group-hover:bg-zynora-emerald group-hover:border-zynora-emerald transition-all">
                  <CheckCircle2 className="w-4 h-4 text-zynora-gold group-hover:text-zynora-cream" />
                </div>
                <span className="font-medium text-zynora-emerald/90 tracking-tight">{reason}</span>
              </motion.div>
            ))}
          </div>

          <div className="mt-4">
            <button className="group relative px-12 py-5 border border-zynora-emerald/20 text-zynora-emerald text-[12px] font-bold tracking-[0.3em] uppercase rounded-full overflow-hidden transition-all duration-700 hover:text-zynora-cream">
